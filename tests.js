...
var A  = new sounds.Note("A",  440.000, 4);
var Bb = new sounds.Note("Bb", 466.164, 4);
var B  = new sounds.Note("B",  493.883, 4);
var C  = new sounds.Note("C",  523.251, 5);
var Db = new sounds.Note("Db", 554.365, 5);
var D  = new sounds.Note("D",  587.330, 5);
...
var G  = new sounds.Note("G",  783.991, 5);
...
console.assert(A.toString() === "name=A freq=440 octave=4", "4");
